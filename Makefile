...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/warehouse1.0.0/ && $(COPY_FILE) --parents mainwindow.h db.h .tmp/warehouse1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp db.cpp .tmp/warehouse1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/warehouse1.0.0/ && (cd `dirname .tmp/warehouse1.0.0` && $(TAR) warehouse1.0.0.tar warehouse1.0.0 && $(COMPRESS) warehouse1.0.0.tar) && $(MOVE) `dirname .tmp/warehouse1.0.0`/warehouse1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/warehouse1.0.0
